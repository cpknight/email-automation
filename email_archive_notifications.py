...
try:
    ...
    SOURCE_FOLDER = config['archive_notifications']['source_folder']
    DEST_FOLDER = config['archive_notifications']['dest_folder']
    BATCH_SIZE = int(config['archive_notifications']['batch_size'])
...
if __name__ == "__main__":
    console.print(f"[grey50][{get_utc_timestamp()}][/grey50] [info]Starting notifications archiving script...[/info]")
